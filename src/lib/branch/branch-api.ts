...
function mapConsultRequest(raw: any): ConsultRequest {
  return {
    ...
    deliveryPurpose: raw.deliveryPurpose ?? raw.delivery_purpose,
    ...
    address: raw.address,
    ribbonText: raw.ribbonText ?? raw.ribbon_text,
    memo: raw.memo,
    invoiceType: raw.invoiceType ?? raw.invoice_type,
    cashReceiptPhone: raw.cashReceiptPhone ?? raw.cash_receipt_phone,
    ribbonImagePath: raw.ribbonImagePath ?? raw.ribbon_image_path,
    businessRegPath: raw.businessRegPath ?? raw.business_reg_path,
    message: raw.message,
