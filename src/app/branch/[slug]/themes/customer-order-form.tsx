  ...
  return (
    <div className="fixed inset-0 z-50 bg-[#f5f5f0]">
      <div className="h-full flex flex-col max-w-lg mx-auto">
        {/* ── Top Navigation Bar ────────────────────────────── */}
        <header className="sticky top-0 z-10 bg-white border-b border-gray-200 flex items-center h-14 px-4 shrink-0">
          <button
            onClick={onClose}
              ...
              <div className="flex gap-4">
                {imgSrc ? (
                  <img
                    src={imgSrc}
                    alt={displayName}
                    className="w-24 h-24 rounded-xl object-contain bg-gray-50 shrink-0"
                  />
                ) : (
                ...
                <div className="flex-1 min-w-0">
                  <h2 className="text-lg font-bold text-gray-900 mb-1 truncate">{displayName}</h2>
                  <p className="text-lg font-bold text-[var(--branch-green)] mb-3">
                    {formatPrice(price)}
                  </p>
