...
export default function BranchManageLayout({
  ...
  const allNavItems = [
    ...
    {
      href: `/branch/${slug}/manage/payments`,
      label: '결제 내역',
      permission: 'wallet',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M9 14h6m-7 4h8M7 4h10a2 2 0 012 2v14l-3-2-3 2-3-2-3 2V6a2 2 0 012-2z" />
        </svg>
      ),
    },
    {
      href: `/branch/${slug}/manage/vbank-logs`,
      label: '가상계좌 로그',
      permission: 'wallet',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M4 7h16M4 12h16M4 17h10M6 4h12a2 2 0 012 2v12a2 2 0 01-2 2H6a2 2 0 01-2-2V6a2 2 0 012-2z" />
        </svg>
      ),
    },
    {
