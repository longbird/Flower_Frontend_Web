...
function GrowthBadge({ label, value }: { label: string; value: number }) {
  ...
  return (
    <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium ${isZero ? 'bg-slate-100 text-slate-500' : isPositive ? 'bg-[#E8F0E0] text-[#5B7A3D]' : 'bg-red-50 text-red-700'}`}>
