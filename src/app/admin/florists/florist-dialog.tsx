      ...
      <div className="flex-1 overflow-y-auto relative min-h-0">
        {activeTab === 'info' ? (
          ...
          <div className="flex flex-col h-full bg-white p-6">
            ...
            {selectedPhoto && (
              <div className="mb-6 p-4 bg-stone-50 border border-stone-200 rounded-xl relative shadow-sm">
                <div className="flex justify-between items-center mb-3">
                  <h4 className="font-bold text-stone-700 flex items-center gap-2">
                    <svg className="w-4 h-4 text-stone-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" /></svg>
                    사진 정보 수정
                  </h4>
                  <button onClick={() => setSelectedPhoto(null)} className="text-stone-400 hover:text-stone-600 p-1 bg-white rounded-md border border-stone-200 shadow-sm">
