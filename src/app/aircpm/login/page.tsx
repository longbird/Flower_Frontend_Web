...
import { APP_BRAND, APP_TAGLINE } from '@/lib/aircpm/branding';
      ...
      <Card className="w-full max-w-md shadow-xl border-slate-200">
        <CardContent className="p-8 md:p-10">
          <div className="text-center mb-8">
            ...
            <h1 className="text-xl font-bold text-slate-900">{APP_BRAND}</h1>
            <p className="text-sm text-slate-500 mt-1.5">{APP_TAGLINE}</p>
          </div>
